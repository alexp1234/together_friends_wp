<?php
			/*
				Template Name: html2wp-how-to-help
			*/
      ...
      <!-- Shared Section -->
        <div class="row">
          ...
          <div class="container-fluid">
            ...
            <div class="container-fluid">
                <h2 style="text-align:center;">Our Kids Need Your Help</h2>
            <div class="row" style="margin-bottom:50px;">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <h2 style="text-align:center;">Our programs depend on help from people like you. Share our 
                    philosophy regarding the "Level of Aspiration" for students in our programs. The main idea here is 
                that: Encouragement leads to Hope, which fosters increased levels of Aspiration.</h2>       
          </div>
          <div class="col-sm-1"></div>       
            ...
            <div class="row">
                ...
                <div class="col-sm-2" style="margin-bottom:50px;">
                    <a href="https://www.paypal.com/donate?hosted_button_id=BVNMUBZ8EBX32" target="_blank">
                      <div class="card shadow gold-bg-card hover-card" style="text-align:center;height:380px;">
                        <h5>INDIVIDUAL <br>GIVING</h5>
                        <p style="text-align:center;">
                        <img src="<?php  bloginfo('template_url');  ?>/img/creditCardSVG.png" style="width:50%;">
                        </p>
                        <p>Includes a mention in marketing media platforms.</p>
                    </div>
                    </a>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-2" style="margin-bottom:50px;">
                    <a href="https://www.paypal.com/donate?hosted_button_id=BVNMUBZ8EBX32" target="_blank">
                    <div class="card shadow dark-white-bg-card hover-card">
                        <h5>SPONSOR <br> A PROGRAM ($500)</h5>
                        <p style="text-align:center;">
                           <img src="<?php  bloginfo('template_url');  ?>/img/calenderSVG.png" style="width:50%;">
                        </p>
                        <p>Includes your company logo on our marketing media platforms.</p>
                    </div>
                    </a>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-2" style="margin-bottom:50px;">
                    <a href="https://www.paypal.com/donate?hosted_button_id=BVNMUBZ8EBX32" target="_blank">
                    <div class="card shadow gold-bg-card hover-card" style="text-align:center;height:380px;">
                        <h5>BUSINESS AND <br> COMMUNITY <br> PARTNERSHIPS ($1000)</h5>
                        <p style="text-align:center;">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/handshakeSVG.png" style="width:50%;">
                        </p>
                        <p>Includes your company logo on our marketing media and a table at our monthly community gatherings.</p>
                    </div>
                    </a>
                </div>
                <div class="col-sm-1"></div>
