<?php
			/*
				Template Name: html2wp-partners
			*/
            ...
            <div class="container-fluid">          
                <div class="row">
                    ...
                    <div class="col-sm-7 text-center">
                        <h2>
                            We Engage with Community Partners that:
                        </h2>
                        <p>
                            Share our philosophy regarding the "Level of Aspiration" for students in our programs. The main idea here is 
                            that: <strong>Encouragement</strong> leads to <strong>Hope</strong>, which fosters an increased level of <strong>Aspiration.</strong>
                        </p>
                    </div>
                </div> 
                <div style="margin-bottom:80px;" class="mt-3">
                    <div class="row">       
                        <div class="col-md-2 ">
                            <p class="text-center">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/unitedWaysLogo.jpg" class="margin-img img-fluid">
                            </p>
                           
                        </div>
                        <div class="col-md-2">
                            <p class="text-center">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/youthEntrepreneursLogo.png" class="margin-img img-fluid">
                            </p>
                           
                        </div>
                         <div class="col-md-4">
                             <p class="text-center">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/JonesBoroLogo.png" class="margin-img img-fluid">
                             </p>
                        </div>  
                        <div class="col-md-2">
                            <p class="text-center">
                                 <img src="<?php  bloginfo('template_url');  ?>/img/sprocketsLogo.png" class="margin-img img-fluid">
                            </p>
                           
                        </div>
                         <div class="col-md-2">
                             <p class="text-center">
                                   <img src="<?php  bloginfo('template_url');  ?>/img/RexMillLogo.png" class="margin-img img-fluid">
                             </p>
                           
                        </div>
                         <div class="col-md-2">
                             <p class="text-center">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/BabbLogo.png" class="margin-img img-fluid">
                             </p>
                           
                         </div>      
                          <div class="col-md-2">
                             <p class="text-center">
                                  <img src="<?php  bloginfo('template_url');  ?>/img/camposlogo.jpg" class="margin-img img-fluid">
                             </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="card shadow gold-bg-card text-center mb-4" style="height:270px;">
                           <h5>FRIENDSHIP LEVEL</h5> 
                           <h1>$250</h1>
                           <p><small>Includes a mention in marketing media platforms.</small></p>
                           <a href="https://www.paypal.com/donate/?hosted_button_id=BVNMUBZ8EBX32">
                            <button class="btn black-card-btn">Donate</button>
                           </a>
                        </div>
                    </div>
                    <div class="col-sm-1"></div>
                     <div class="col-md-2">
                        <div class="card shadow gold-bg-card text-center mb-4" style="height:270px;">
                           <h5>SPONSORSHIP LEVEL</h5> 
                           <h1>$500</h1>
                           <p><small>Includes your company logo on our marketing media platforms.</small></p>
                           <a href="https://www.paypal.com/donate/?hosted_button_id=BVNMUBZ8EBX32">
                            <button class="btn black-card-btn">Donate</button> 
                           </a>
                        </div>
                    ...
                    <div class="col-sm-1"></div>
                     <div class="col-md-2">
                        <div class="card shadow gold-bg-card text-center mb-4" style="height:270px;">
                           <h5>PARTNER LEVEL</h5> 
                           <h1>$1000</h1>
                           <p><small>Company logo on our marketing media and table at monthly community gatherings.</small></p>
                           <a href="https://www.paypal.com/donate/?hosted_button_id=BVNMUBZ8EBX32">
                            <button class="btn black-card-btn">Donate</button>
                           </a>
                        </div>
