<?php
			/*
				Template Name: html2wp-programs-and-services-discover-me
			*/
...
<link rel="mask-icon" href="<?php  bloginfo('template_url');  ?>/img/favicons/safari-pinned-tab.svg" color="#7952b3">
<link rel="icon" href="<?php  bloginfo('template_url');  ?>/img/favicons/favicon.ico">
            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-md-8 offset-md-2">
                        <h2> Discover Me Summer Bootcamp Program</h2>
                    </div>
                </div>
                <div class="row">
